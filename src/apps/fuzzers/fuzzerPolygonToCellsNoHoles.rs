...
pub unsafe extern "C" fn LLVMFuzzerTestOneInput(
    ...
    if size < ::core::mem::size_of::<libc::c_int>() as libc::c_ulong {
        return 0 as libc::c_int;
    }
    let mut res: uint8_t = *data;
    let mut vertsSize: size_t = size.wrapping_sub(1 as libc::c_int as libc::c_ulong);
    let mut numVerts: libc::c_int =
        vertsSize.wrapping_div(::core::mem::size_of::<LatLng>() as libc::c_ulong) as libc::c_int;
